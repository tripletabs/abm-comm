...
def initialize():
    ...
    # initialize an array to record clustering coefficient (average clustering)
    cc_array = [nx.average_clustering(g)]
...
def update():
    ...
    # record the clustering coefficient for each step
    cc_array.append(nx.average_clustering(g))
...
# ax.set_title("Change of Average Clustering")
# show()
# savefig("average_clustering-0.1.png")
#
# cla()
# clf()
...
ax.set_title("Change of Average Clustering")
show()
savefig("average_clustering-0.5.png")
...
ax.set_title("Change of Average Clustering")
show()
savefig("average_clustering-0.9.png")
